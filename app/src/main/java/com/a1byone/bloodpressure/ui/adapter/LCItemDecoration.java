...
public class LCItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public LCItemDecoration(Context context) {
        this(context, VERTICAL_LIST, -1, -1);
    }

    public LCItemDecoration(Context context, int orientation) {
        this(context, orientation, -1, -1);
    }

    public LCItemDecoration(Context context, int orientation, int padding, int dividerHeight) {
    ...
    public LCItemDecoration(Context context, int orientation, int startpadding, int endpadding, int dividerHeight) {
        setOrientation(orientation);
        mContext = context;
